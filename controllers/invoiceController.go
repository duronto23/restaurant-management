...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		allOrderItems, err := ItemsByOder(invoice.Order_id)
		invoiceView.Oeder_id = invoice.Order_id
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if insertErr != nil {
			msg := fmt.Sprintf("invice item not created")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
		defer cancel()
...
func UpdateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("invoice utem update failed")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
